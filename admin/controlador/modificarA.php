...
">Formulario</h2>
            ...
            <form id= "formulario" method="POST"   action="/hypermedial/Practica-PHP/Practica04-Mi-Agenda-Telef-nica/admin/controlador/modificarAdministrador.php" >
                <fieldset style="
    WIDTH: 50%;
    margin-top: 112px;
    margin-left: 375px;
">
                   <legend>Modificar:</legend>
                        ...
                        <div><label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Cedula:&nbsp;&nbsp;&nbsp;</label><input type='text' id="cedula" name="cedula" value='<?php echo $row["usu_cedula"] ?>'></div><br>
                         ...
                         <div><label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Rol:</label><input type='text' id="rol" name="rol" value='<?php echo $row["usu_rol"] ?>' ></div><br>
                         <div><label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Correo:&nbsp;&nbsp;&nbsp;</label><input id="Correo" name="Correo" type='text' value=' <?php echo $row["usu_correo"] ?>'></div><br>
                         <div><label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Contraseña:</label><input type='password' id="password" name="password" value='<?php echo $row["usu_contrasena"] ?>' ></div><br>
...
<script src=ValidarUAdministrador.js></script>
</body>
