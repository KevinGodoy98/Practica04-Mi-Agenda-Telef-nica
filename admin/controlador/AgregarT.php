...
">
        ...
        <?php
         ...
         $sql = "SELECT * FROM telefonos WHERE tel_codigo = $codigo AND tel_usu_codigo= $codigou";
...
">Formulario</h2>
            ...
            <form id= "formulario" method="POST" action="/hypermedial/Practica-PHP/Practica04-Mi-Agenda-Telef-nica/admin/controlador/AgregarTelefonoAdmin.php">
                <fieldset style="
    WIDTH: 50%;
    margin-top: 112px;
    margin-left: 375px;
