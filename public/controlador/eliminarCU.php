...
<head>
 <meta charset="UTF-8">
 <title>eliminar Contraseña Usuario</title>
...
">Formulario</h2>
            ...
            <form id= "formulario" method="POST"   action="/hypermedial/Practica-PHP/Practica04-Mi-Agenda-Telef-nica/public/controlador/eliminarContraU.php" >
                <fieldset style="
    WIDTH: 50%;
    margin-top: 112px;
    margin-left: 375px;
">
                   <legend>Eliminar Contraseña:</legend>
                        <br>
                            <br>
                        <input type="hidden" id="codigo" name="codigo" value="<?php echo $codigo ?>" />
                        <div><label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Contraseña:</label><input type='password' id="password" name= "password"  value= "<?php echo $row["usu_contrasena"] ?>" style="width:310px"></div><br>
                         <input type="submit"  id="btnValidar"  value="Eliminar" style="float: right;width: 20%; " > 
