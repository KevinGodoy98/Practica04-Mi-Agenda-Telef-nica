...
<head>
 <meta charset="UTF-8">
 <title>Eliminar Telefonos Usuario</title>
...
">Formulario</h2>
            ...
            <form id= "formulario" method="POST" action="/hypermedial/Practica-PHP/Practica04-Mi-Agenda-Telef-nica/public/controlador/eliminarUsuario.php">
                <fieldset style="
    WIDTH: 50%;
    margin-top: 112px;
    margin-left: 375px;
